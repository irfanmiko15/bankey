...
//  bankey
//
//  Created by Irfan Dary on 22/03/24.
//
...
extension ShakeyBellView{
    @objc func imageViewTapped(_ recognize:UITapGestureRecognizer){
        shakeWith(duration: 1.0, angle: .pi/8, yOffset: 0.0)
    }
    
    private func shakeWith(duration: Double, angle: CGFloat, yOffset: CGFloat){
        let numberOffFrames: Double = 6
        let frameDuration = Double(1/numberOffFrames)
        
        imageView.setAnchorPoint(CGPoint(x: 0.05, y: yOffset))
